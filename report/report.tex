...
The simulation of one day is performed through the method \textit{simulate\_one\_day(pricing\_strategy, bidding\_strategy)}, exposed by the environment.
\newline
Here the code:
...
arms we perform normal regression with the data of our random variable (the new clicks) and assuming we do not sell the
...
\clearpage
\subsection{Experiment 1}
\makebox[\linewidth]{\includegraphics[scale=0.4]{figures/step7/env0.png}}
\makebox[\linewidth]{\includegraphics[scale=0.7] {figures/step7/plot0.png}}

\clearpage
{\footnotesize\verbatiminput{figures/step7/output0.txt}}

\clearpage
\subsection{Experiment 2}
\makebox[\linewidth]{\includegraphics[scale=0.4]{figures/step7/env1.png}}
\makebox[\linewidth]{\includegraphics[scale=0.7] {figures/step7/plot1.png}}

\clearpage
{\footnotesize\verbatiminput{figures/step7/output1.txt}}

\clearpage
\subsection{Experiment 3}
\makebox[\linewidth]{\includegraphics[scale=0.4]{figures/step7/env2.png}}
\makebox[\linewidth]{\includegraphics[scale=0.7] {figures/step7/plot2.png}}

\clearpage
{\footnotesize\verbatiminput{figures/step7/output2.txt}}
