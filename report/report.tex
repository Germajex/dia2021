...
The estimation can be done easily because none of the quantities to estimate depends both on $p$ and $b$, therefore the data can be used more efficiently.  Using the estimation the learner will choose $(p_i,b_i)$ and the learning process will move one round forward.
