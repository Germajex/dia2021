...
For each context, among all the splits that are convenient, it takes the one that is convenient by the smallest amount. The rationale behind this is that it is more likely that the more convenient split will be performed the next round even if a split was just done.\\
