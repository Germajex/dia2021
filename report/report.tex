...
\begin{figure}[h]
  ...
  \includegraphics[width=1.4\textwidth]{figures/step3/env0.png}}
	\includegraphics[scale=0.8] {figures/step3/plot0.png}
\end{figure}
\clearpage
...
\begin{figure}[h]
  \noindent\makebox[\textwidth]{%
  \includegraphics[width=1.4\textwidth]{figures/step3/env1.png}}
	\includegraphics[scale=0.8] {figures/step3/plot1.png}
\end{figure}
\clearpage
