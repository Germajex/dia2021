...
\begin{align*}
r_c(p) = \frac{1}{1+e^{-z_c(P_c-x)}}
\end{align*}
Where $P_c$, the inflection point of the sigmoid, can be seen as the average reserve price of the users of the class and $z_p$ can be seen as the precision of the user in estimating their own reserve price: if $z_c$ is small the function will be more flat and many points around $P_c$ will have a probability that is neither 1 or 0, while as $z_c$ grows, at the point $P_c$ there is a rapid transition from "buy" to "don't buy".
